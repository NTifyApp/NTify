...
import com.spotifyxp.deps.com.spotify.context.ContextPageOuterClass.ContextPage;
...
import com.spotifyxp.deps.com.spotify.playlist4.Playlist4ApiProto.PlaylistModificationInfo;
...
public class StateWrapper implements DeviceStateHandler.Listener, DealerClient.MessageListener, Closeable {
    static {
        try {
            ...
            ProtoUtils.overrideDefaultValue(com.spotifyxp.deps.com.spotify.connectstate.Player.PlayerState.getDescriptor().findFieldByName("position_as_of_timestamp"), -1);
